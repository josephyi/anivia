        ...
        return (
            <Grid><Row>
                <Col xs={12} md={12}>
                    <Jumbotron>
                        <h1>Let's soar.</h1>
                        <p>Anivia is an open source single page web application built with a React/Redux frontend, Elixir/Phoenix backend, and data
                            from Riot Games' <a target="new" href="https://developer.riotgames.com/">League of Legends API</a>.
                        </p>
                        <p>Check out the source at <a href="https://github.com/josephyi/anivia">https://github.com/josephyi/anivia</a></p>
                    </Jumbotron>

                    <h1>Featured Games</h1>
                    <FeaturedGames featuredGames={this.props.featuredGames["gameList"]} region={this.props.region}
                                   rankedLeagues={this.props.rankedLeagues} summoners={this.props.summoners}/>
                </Col></Row></Grid>
        )
    }
}
