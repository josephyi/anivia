...
class Home extends Component {
    ...
    render() {
        return(
            <Grid><Row>
                <Col xs={12} md={12}>
            <FeaturedGames featuredGames={this.props.featuredGames["gameList"]} region={this.props.region} rankedLeagues={this.props.rankedLeagues} summoners={this.props.summoners} />
            </Col></Row></Grid>
        )
    }
}
